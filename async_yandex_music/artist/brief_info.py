...
if TYPE_CHECKING:
    from async_yandex_music import Client, Artist, Track, Album, Cover, PlaylistId, Video, Chart, Vinyl, Playlist
...
class BriefInfo(YandexMusicObject):
    ...
    def de_json(cls, data: dict, client: 'Client') -> Optional['BriefInfo']:
        ...
        from async_yandex_music import Artist, Track, Album, Cover, PlaylistId, Video, Chart, Vinyl, Playlist
