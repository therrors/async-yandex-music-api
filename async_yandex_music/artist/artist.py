...
if TYPE_CHECKING:
    from async_yandex_music import Client, Cover, Ratings, Counts, Link, Track, Description, ArtistTracks, ArtistAlbums
...
class Artist(YandexMusicObject):
    ...
    def de_json(cls, data: dict, client: 'Client') -> Optional['Artist']:
        ...
        from async_yandex_music import Cover, Ratings, Counts, Link, Track, Description
