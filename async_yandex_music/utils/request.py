...
from async_yandex_music.utils.captcha_response import CaptchaResponse
from async_yandex_music.utils.response import Response
from async_yandex_music.exceptions import Unauthorized, BadRequest, NetworkError, YandexMusicError, CaptchaRequired, \
    CaptchaWrong, TimedOut

if TYPE_CHECKING:
    from async_yandex_music import Client
...
class Request:
    """Вспомогательный класс для async_yandex_music, представляющий методы для выполнения POST и GET запросов, скачивания
    файлов.
