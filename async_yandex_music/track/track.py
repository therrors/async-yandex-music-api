...
from async_yandex_music.exceptions import InvalidBitrate

if TYPE_CHECKING:
    from async_yandex_music import Client, Normalization, Major, Album, Artist, Supplement,\
...
class Track(YandexMusicObject):
    ...
    def de_json(cls, data: dict, client: 'Client') -> Optional['Track']:
        ...
        from async_yandex_music import Normalization, Major, Album, Artist, User, MetaData, PoetryLoverMatch
