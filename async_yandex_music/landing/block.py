...
if TYPE_CHECKING:
    from async_yandex_music import Client, BlockEntity, PersonalPlaylistsData, PlayContextsData
...
class Block(YandexMusicObject):
    ...
    def de_json(cls, data: dict, client: 'Client') -> Optional['Block']:
        ...
        from async_yandex_music import BlockEntity, PlayContextsData, PersonalPlaylistsData
