...
if TYPE_CHECKING:
    from async_yandex_music import Client, Account, Permissions, Subscription, Plus, StationData, Alert
...
class Status(YandexMusicObject):
    ...
    def de_json(cls, data: dict, client: 'Client') -> Optional['Status']:
        ...
        from async_yandex_music import Account, Permissions, Plus, Subscription, StationData, Alert
