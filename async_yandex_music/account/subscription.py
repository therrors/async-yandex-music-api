...
if TYPE_CHECKING:
    from async_yandex_music import Client, AutoRenewable, RenewableRemainder, NonAutoRenewable, Operator
...
class Subscription(YandexMusicObject):
    ...
    def de_json(cls, data: dict, client: 'Client') -> Optional['Subscription']:
        ...
        from async_yandex_music import AutoRenewable, RenewableRemainder, NonAutoRenewable, Operator
