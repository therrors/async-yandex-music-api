...
from async_yandex_music import Album, Artist, ArtistAlbums, ArtistTracks, BriefInfo, Dashboard, DownloadInfo, Experiments, \
...
from async_yandex_music.exceptions import Captcha, InvalidToken
from async_yandex_music.utils.difference import Difference
from async_yandex_music.utils.request import Request
...
class Client(YandexMusicObject):
    ...
    async def rotor_station_feedback_radio_started(self, station: str, from_: str, batch_id: str = None,
        ...
        Raises:
            :class:`yandex_music.exceptions.YandexMusicError`: Базовое исключение библиотеки.
        """
        return await self.rotor_station_feedback(station, 'radioStarted', timestamp, from_=from_, batch_id=batch_id,
    ...
    async def rotor_station_feedback_track_started(self, station: str, track_id: Union[str, int], batch_id: str = None,
        ...
        Raises:
            :class:`yandex_music.exceptions.YandexMusicError`: Базовое исключение библиотеки.
        """
        return await self.rotor_station_feedback(station, 'trackStarted', timestamp, track_id=track_id, batch_id=batch_id,
                                           timeout=timeout, *args, **kwargs)
    ...
    async def rotor_station_feedback_track_finished(self, station: str, track_id: Union[str, int],
        ...
        Raises:
            :class:`yandex_music.exceptions.YandexMusicError`: Базовое исключение библиотеки.
        """
        return await self.rotor_station_feedback(station, 'trackFinished', timestamp, track_id=track_id,
    ...
    async def rotor_station_feedback_skip(self, station: str, track_id: Union[str, int],
        ...
        Raises:
            :class:`yandex_music.exceptions.YandexMusicError`: Базовое исключение библиотеки.
        """
        return await self.rotor_station_feedback(station, 'skip', timestamp, track_id=track_id,
                                           total_played_seconds=total_played_seconds, batch_id=batch_id,
                                           timeout=timeout, *args, **kwargs)
