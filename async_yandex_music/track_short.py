...
if TYPE_CHECKING:
    from async_yandex_music import Client, Track, Chart
...
class TrackShort(YandexMusicObject):
    ...
    async def fetch_track(self) -> 'Track':
        ...
        self._track = await self.client.tracks(self.track_id)
        self._track = self._track[0]
    ...
    def de_json(cls, data: dict, client: 'Client') -> Optional['TrackShort']:
        ...
        from async_yandex_music import Track, Chart
